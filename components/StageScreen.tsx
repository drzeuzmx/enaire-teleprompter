...
export default function StageScreen({
  ...
  // Continuously eases the container toward scrollTargetRef instead of using
  // the browser's native smooth-scroll, which restarts (and visibly jumps)
  // every time a new target arrives mid-animation -- the main cause of the
  // jerky, too-fast motion on mobile.
  const animateScroll = useCallback(() => {
    ...
    container.scrollTop = current + delta * 0.15;
  ...
  const scrollToIndex = useCallback(
    ...
    [settings.activeLinePosition, animateScroll]
  );
